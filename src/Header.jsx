...
import HeaderCenter from './Pages/HeaderCenter';
...
const Header = () => {
  ...
  return (
    <div className={`bg-white dark:bg-gray-900 transition-colors duration-300 ${darkMode ? 'dark' : ''}`}>
      <header className='flex flex-col sm:flex-row justify-between items-center p-4'>
        ...
        {/* Navigation Links */}
        <div className='hidden sm:flex sm:flex-row gap-4 text-lg sm:text-xl mb-4 sm:mb-0 dark:text-white'>
          <div>Stays</div>
          <div>Experience</div>
        </div>
        ...
        <div className='flex items-center gap-3'>
          ...
          <div className='hidden sm:flex items-center dark:text-white'>
            Airbnb your home
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
          ...
          <Link
            to="/login"
            className='flex gap-2 border border-gray-300 rounded-full px-4 py-2 sm:py-3 shadow-md shadow-gray-300 dark:border-gray-700 dark:shadow-gray-800'
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
